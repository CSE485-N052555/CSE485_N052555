...
<div class="container-fluid">
  ...
  <div class="card mb-3">
    <div class="card-header">
      ...
      <button type="button" class="btn btn-outline-danger"><i class="icon ion-md-trash"></i>Xóa</button>
      </div>
    </div>
    <div class="card-body">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="../lib/xulisp.php"  method="GET" enctype="multipart/form-data">
...
<div class="modal fade" id="exampleModal1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="../lib/xulisp.php"  method="GET">
          <div class="form-group">
          <label for="message-text" class="control-label">Tên Loại Sản Phẩm</label>
          <input type="text" name="tenloaisp" id="inputdanhmuc" class="form-control" value="" required="required" placeholder="Nhập Tên Sản Phẩm...">
          <label  class="control-label">Ảnh:</label><input type="file" name="img" id="" value="" required="required" accept="image/png, image/jpeg" >
          <input type="text" name="gia" id="" required="required" placeholder="Nhập Giá....">
          <div class="checkbox">
            <label>
              <input type="checkbox" value="1" name="hot">
